...
@property (strong, nonatomic) AVCapturePhotoOutput *stillImageOutput; //changed from AVCaptureStillImageOutput to ...
...
- (void)initialize {
   ...
   //     [self.stillImageOutput setOutputSettings:outputSettings]; //error
   
        AVCapturePhotoSettings *photoOutputSettings = [AVCapturePhotoSettings photoSettings];
        
        [self.stillImageOutput capturePhotoWithSettings:photoOutputSettings delegate: self];
...
//    [self.stillImageOutput
         ...
         if (imageSampleBuffer != NULL) {
             ...
             //NSData *imageData = [AVCapturePhotoOutput  jpegStillImageNSDataRepresentation:imageSampleBuffer];
